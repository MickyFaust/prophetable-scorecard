...
app.get('/admin/migrate-history', (req, res) => {
    ...
    try {
        ...
        fs.writeFileSync(DATA_PATH, JSON.stringify(part1, null, 2));
        res.send(`<h1>Migration Successful!</h1><p>${part1.length} plays imported.</p><a href='/'>Go Home</a>`);
    } catch (err) {
...
app.get('/api/plays', (req, res) => {
    if (fs.existsSync(DATA_PATH)) {
        res.json(JSON.parse(fs.readFileSync(DATA_PATH)));
    } else { res.json([]); }
});
...
{"id":7,"date":"2026-03-03","league":"NBA","tier":"PROPHET ELITE","matchup":"Heat vs Pistons","pick":"Heat -6.5","odds":"-110","units":1.0},
        ...
        {"id":43,"date":"2026-03-21","league":"NCAAB","tier":"PROPHET ELITE","matchup":"Round of 32 G
